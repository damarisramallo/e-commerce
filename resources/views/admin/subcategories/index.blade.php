<x-admin-layout :breadcrumbs="[
                    ...
                    @foreach ($subcategories as $subcategory)
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                            ...
                            <td class="px-6 py-4 text-right">
                                <a href="{{ route('admin.subcategories.edit', $subcategory) }}" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Editar</a>
                            </td>
    ...
    @else
        ...
        <div>
            <span class="font-medium">Info alert!</span> Todavía no hay subcategorías registradas. 
        </div>
